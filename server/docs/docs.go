...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序'1.active', '2.upcoming', '3.all'",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序'1.price_asc'(関連度順), '2.newest'(価格安い順)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序'1.relevance'(関連度順), '2.price_asc'(価格安い順), '3.price_desc'(価格高い順), '4.newest'(新着順)。",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/products/{product_code}/coordinates": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/products/{product_code}/qa": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序1.最新开始 2.最早开始 3.点赞数从高到低，默认1",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/products/{product_code}/related": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/products/{product_code}/reviews": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序1.最新开始 2.最早开始 3.评价从高到低 4.评价从低到高 5.点赞数从高到低，默认1",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.UserCartItemsQuantityRes"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1,
                        "description": "排序1.最新开始 2.最早开始 默认1",
                        "name": "sort",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 6,
                        "description": "订单状态1.pending_payment 2.delivered 3.shipped 4.processing 5.cancelled 6.all 默认1",
                        "name": "status",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/system.OrderInfo"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
        ...
        "/api/v2/orders/checkout/apply-coupon": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.ApplyCouponRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/system.ShippingAddressInput"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
        ...
        "/api/v2/orders/checkout/use-points": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.UsePointsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v2/shipping-addresses/{address_id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysOperationRecord/deleteLoginRecordById": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "分页获取UserLogin列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/sysOperationRecord/getSysOperationRecordLoginById": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "system.OrderInfo": {
            ...
            "properties": {
                ...
                "total_amount": {
                    "description": "支払総額 (計算用数値)",
                    "type": "number"
                }
            }
        },
        "system.ShippingAddressInput": {
            "type": "object",
            "required": [
                "address_line1",
                "city",
        ...
        "system.UserCartItemsQuantityRes": {
            "type": "object",
            "properties": {
                "quantity": {
                    "description": "UserId    uint\nSkuId     string",
                    "type": "integer"
                }
            }
        }
