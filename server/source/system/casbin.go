...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/sysOperationRecord/getSysOperationRecordLoginById", V2: "GET"},
		...
		{Ptype: "p", V0: "888", V1: "/sysOperationRecord/deleteLoginRecordById", V2: "DELETE"},

		{Ptype: "p", V0: "888", V1: "/api/v1/products/:product_code", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v1/products/:product_code/reviews", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v1/products/:product_code/qa", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v1/products/images/:sku_id", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v2/favorites/skus", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v2/favorites/skus/:sku_id", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/api/v2/favorites/skus/:sku_id", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/api/v1/products/:product_code/related", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v1/products/:product_code/coordinates", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v2/history/viewed-skus", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v2/history/viewed-skus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/api/v2/cart", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/api/v2/cart/items", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/api/v2/cart/items/:sku_id", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/api/v2/cart/items/:sku_id", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/api/v2/shipping-addresses", V2: "GET"},
		...
		{Ptype: "p", V0: "888", V1: "/api/v2/orders/checkout/apply-coupon", V2: "POST"},
